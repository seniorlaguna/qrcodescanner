...
import de.seniorlaguna.barcodescanner.databinding.FragmentCreateCode39Binding
...
class CreateCode39Fragment : BaseCreateBarcodeFragment() {
    ...
    private var binding : FragmentCreateCode39Binding? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentCreateCode39Binding.inflate(inflater, container, false)
        return binding!!.root
    }
