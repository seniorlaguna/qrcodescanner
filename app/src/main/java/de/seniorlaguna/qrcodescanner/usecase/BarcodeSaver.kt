package de.seniorlaguna.qrcodescanner.usecase
...
import de.seniorlaguna.qrcodescanner.extension.endsWithIgnoreCase
...
import de.seniorlaguna.qrcodescanner.model.ExportBarcode
...
object BarcodeSaver {
    ...
    private fun trySaveBarcodeHistoryAsJson(context: Context, fileName: String, barcodes: List<ExportBarcode>) {
        val jsons = barcodes.map(BarcodeSaver::convertToJson)
